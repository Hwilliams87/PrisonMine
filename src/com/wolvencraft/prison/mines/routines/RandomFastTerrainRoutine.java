...
import com.wolvencraft.prison.mines.util.BlocksUtil;
...
public class RandomFastTerrainRoutine {    
                ...
                for (int y = one.getBlockY(); y <= two.getBlockY(); y++) {
                    for (int z = one.getBlockZ(); z <= two.getBlockZ(); z++) {
                        try { 
                            ...
                            BlocksUtil.setBlockSuperFast(original, newBlock.getItemTypeId(), newBlock.getData());
                        }
